 ...
 */
class appApp_AppKernelProdContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'console.command.public_alias.AmoCrm\\Command\\DealBasicToTargetCommand' => 'getDealBasicToTargetCommandService.php',
            'console.command.public_alias.AmoCrm\\Command\\FunnelBasicToTargetCommand' => 'getFunnelBasicToTargetCommandService.php',
    ...
    protected function getRouterService()
    {
        ...
        ]))->withContext('router.default', $this), 'kernel::loadRoutes', ['cache_dir' => $this->targetDirs[0], 'debug' => false, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appApp_AppKernelProdContainerUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appApp_AppKernelProdContainerUrlMatcher', 'strict_requirements' => true, 'resource_type' => 'service'], ($this->privates['router.request_context'] ?? $this->getRouter_RequestContextService()), new \Symfony\Component\DependencyInjection\ParameterBag\ContainerBag($this), $a);
    ...
    {
        return $this->privates['debug.debug_handlers_listener'] = new \Symfony\Component\HttpKernel\EventListener\DebugHandlersListener(NULL, NULL, NULL, 0, false, new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter(NULL), false);
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.container_class' => 'appApp_AppKernelProdContainer',
            'container.dumper.inline_class_loader' => true,
            'locale' => 'ru',
            'database_host' => 'icontextdev.ru',
            'database_port' => 3306,
            'database_name' => 'yandex_handbook',
            'database_user' => 'yandex_handbook',
            'database_password' => 'qsefwesds',
            'basic.login' => 'anya@icontext.ru',
            'basic.pass' => '!O3xJ*De7S2O',
            'basic.hash' => 'c9d172b0fee534eb6ba2899f9f05b8470c26ca6b',
            'target.login' => 'k.samsonov@icontextgroup.ru',
            'target.pass' => 'Pa$$1234',
            'target.hash' => 'b85f7aac44825172bb4c1e904a84fbd8212c0350',
            'host.basic' => 'https://icontextall.amocrm.ru',
            'host.target' => 'https://new5832c10517fd6.amocrm.ru',
            'auth.post' => '/private/api/auth.php',
            'deal.get' => '/api/v2/leads',
            'funnel.get' => '/api/v2/pipelines',
            'funnel.post' => '/private/api/v2/json/pipelines/set',
            'funnel.delete' => '/private/api/v2/json/pipelines/delete',
            'kernel.secret' => '1cff313fe2c7ea760869c89ead447314',
            ...
            'router.cache_class_prefix' => 'appApp_AppKernelProdContainer',
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.AmoCrm\\Command\\DealBasicToTargetCommand',
                1 => 'console.command.public_alias.AmoCrm\\Command\\FunnelBasicToTargetCommand',
            ],
        ];
    }
}
